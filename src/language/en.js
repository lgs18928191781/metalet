export default {
  ...
  wallet: {
    ...
    create_wallet_notice_4:
      "You will need these words to restore your wallet if your browser's storage is cleared or your device is damaged or lost.",
    ...
    set_password_notice_2:
      'If you forget your password you will need to restore your wallet using your mnemonic words.',
    ...
    mnemonic_notice_4:
      'If you ever change browsers or move computers, you will need the Mnemonic Words to access this account. Save them somewhere safe and secret.',
    ...
    private_notice_4:
      'If you ever change browsers or move computers, you will need this Private Key to access this account. Save them somewhere safe and secret.',
    ...
    passphrase_notice_1:
      'The passphrase can provide additional protection to your assets. Even if your mnemonic is stolen, your assets are safe if the passphrase is not revealed.',
    passphrase_notice_2: 'If the passphrase is set, you need to input this when importing your mnemonic words.',
    passphrase_notice_3:
      'If the passphrase is set, but the 12 mnemonic words are imported without inputing the passphrase, the wallet with the passphrase will NOT be restored and a new wallet without the passphrase will be created.',
    passphrase_notice_4:
      'The passphrase is not saved. So please be careful that, if you forget it, you will never be able to restore your assets.',
    der_path: 'Derivation Path:',

    passphrase_import_notice_1: 'You should input this if you have set it before.',
    passphrase_import_notice_2:
      "If you input a wrong passphrase, the restored wallet won't be the same wallet with the original passphrase.",
