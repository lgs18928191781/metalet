<template>
  <div class="address-input">
    <div class="input-container" :class="{ 'has-error': inputErrorNotice !== '' }">
      <a-input
        ref="addressInputEle"
        v-model:value="transAddress"
        @change="addressChange"
        :placeholder="$t('account.input_address')"
      />
...
export default {
  ...
  methods: {
    ...
    async focusInput() {
      if (this.$refs.addressInputEle) this.$refs.addressInputEle.focus();
    },
  },
};
</script>
